         ...
         <div id="bodycontainer">
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                    ...
                    <a href="http://feedly.com/#subscription/feed/{$feedUrl}" onclick="subscribeNow(this.href,'Feedly');return true"><img src="http://s3.feedly.com/feedburner/feedly.png" alt="Subscribe with Feedly"/></a>

                    <a href="http://www.netvibes.com/subscribe.php?url={$feedUrl}" onclick="this.href=subscribeNow(this.href,'Netvibes');return true"><img src="http://www.netvibes.com/img/add2netvibes.gif" alt="Add to netvibes" /></a>
                    ...
                    <a href="https://www.subtome.com/#/subscribe?feeds={$feedUrl}" onclick="subscribeNow(this.href,'SubToMe');return true"><img src="http://www.subtome.com/subtome-feedburner.png" alt="Subscribe with SubToMe"/></a>
              </xsl:otherwise>
            </xsl:choose>
                     </div>
                     <h4>...with iTunes:</h4>
