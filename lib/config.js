...
module.exports.published_dir = process.env.MP3ME_PUBLISHED_DIR || process.env.HOME + '/Dropbox/Web/podcast/content';
module.exports.baseurl = 'http://dropbox.ernie.org/podcast/content/';
